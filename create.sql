...
create table user_detail(user_id int(10), home_campus varchar(25), age int(3), major varchar(25), sexual_preference varchar(25), bio varchar(256), purpose int(1), primary key(user_id)) ENGINE=InnoDB;
create table user_purpose(pur_num int(1), pur_name varchar(25), primary key(pur_num, pur_name)) ENGINE=InnoDB;
create table user_message(message_id int(10) NOT NULL AUTO_INCREMENT, sending_user int(10), receiving_user int(10), sent_date datetime, content varchar(2048), primary key(message_id)) ENGINE=InnoDB;
